...
model = RT(input_channels, args.d_model, n_classes, h=args.h, rnn_type=args.rnn_type, ksize=args.ksize, 
    n_level=args.n_level, n=args.n, dropout=args.dropout, emb_dropout=args.dropout, butterfly=args.butterfly)
...
model_name = "d_{}_h_{}_t_{}_ksize_{}_level_{}_n_{}_lr_{}_dropout_{}_butterfly_{}".format(
