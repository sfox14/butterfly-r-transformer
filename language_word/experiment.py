...
parser.add_argument('--rnn_type', type=str, default='LSTM', 
                    help="use 'CUSTOM' and 'args.butterfly' for butterfly LSTM")
...
parser.add_argument('--butterfly', action='store_true', help="BB Butterfly representation")
parser.set_defaults(butterfly=False)
...
model = RT(args.d_model, n_words, h=args.h, rnn_type=args.rnn_type, ksize=args.ksize, 
            n_level=args.n_level,  n=args.n, dropout=dropout, emb_dropout=emb_dropout, tied_weights=tied, butterfly=args.butterfly)

model.to(device)


model_name = "d_{}_h_{}_type_{}_ks_{}_level_{}_n_{}_lr_{}_drop_{}_butterfly_{}".format(args.d_model, args.h, args.rnn_type, args.ksize, 
                                                            args.n_level, args.n, args.lr, args.dropout, args.butterfly)
